...
import { X } from "lucide-react"  // ✅ Use correct icon name
...
// ✅ Add showCloseButton to props interface
interface SheetContentProps
  extends React.ComponentPropsWithoutRef<typeof SheetPrimitive.Content>,
    VariantProps<typeof sheetVariants> { // 👈 Change this from sheetContentVariants
