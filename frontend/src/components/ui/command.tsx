  ...
  return (
    <Dialog {...props}>
      ...
      <DialogContent
        ...
        // `showCloseButton` is not supported by DialogContent in your current dialog.tsx.
        // Command palettes typically rely on Escape/OutsideClick to close, so it's omitted here.
      >
        {children}
      </DialogContent>
    </Dialog>
