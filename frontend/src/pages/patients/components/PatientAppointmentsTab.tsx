        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div>
            ...
            <select
              ...
              className={cn(inputCls, "bg-white")}
            >
              {APPOINTMENT_TYPES.map((t: { value: string; label: string }) => (
...
function AppointmentCard({
  ...
  return (
    <div
      className={cn(
        "rounded-2xl border-2 border-slate-200 overflow-hidden transition-all hover:border-slate-300 hover:shadow-sm",
      )}
    >
    ...
    <div className="space-y-5">
      ...
      {!isLoading && !error && allAppointments.length > 0 && (
        <div className="space-y-6">
          ...
          {/* No upcoming message */}
          {/* {(filter === "all" || filter === "upcoming") && visibleUpcoming.length === 0 && !isLoading && (
